...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Check every 10 seconds to show tickets in real-time as they are raised
...
`;
      ...
      <Card className="border shadow-sm overflow-hidden">
        <div className="flex items-center justify-between p-4">
          ...
          <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 uppercase font-black text-[10px]">
